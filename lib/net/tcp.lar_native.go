...
type lar_cls_3_net_11_TcpListener struct {
    ntl *net.TCPListener
}

func lar_new_obj_lar_cls_3_net_11_TcpListener(addr *lar_cls_10___builtins_6_String) *lar_cls_3_net_11_TcpListener {
    ...
    return &lar_cls_3_net_11_TcpListener{ntl: ntl}
}

func (this *lar_cls_3_net_11_TcpListener) method_get_addr() *lar_cls_10___builtins_6_String {
    return lar_util_create_lar_str_from_go_str(this.ntl.Addr().String())
}

func (this *lar_cls_3_net_11_TcpListener) method_accept() *lar_cls_3_net_7_TcpConn {
    ...
    return &lar_cls_3_net_7_TcpConn{ntc: ntc}
}

func (this *lar_cls_3_net_11_TcpListener) method_close() {
    this.ntl.Close()
}

type lar_cls_3_net_7_TcpConn struct {
    ntc *net.TCPConn
}

func (this *lar_cls_3_net_7_TcpConn) method_get_local_addr() *lar_cls_10___builtins_6_String {
    return lar_util_create_lar_str_from_go_str(this.ntc.LocalAddr().String())
}

func (this *lar_cls_3_net_7_TcpConn) method_get_remote_addr() *lar_cls_10___builtins_6_String {
    return lar_util_create_lar_str_from_go_str(this.ntc.RemoteAddr().String())
}

func (this *lar_cls_3_net_7_TcpConn) method_send(buf *[]uint8, begin, length int64) {
...
func (this *lar_cls_3_net_7_TcpConn) method_recv(buf *[]uint8, begin, length int64) int64 {
    buf_len := int64(len(*buf))
    end := begin + length
    if begin < 0 || begin > buf_len || end < 0 || end > buf_len || end < begin {
...
func (this *lar_cls_3_net_7_TcpConn) method_close() {
    this.ntc.Close()
}
